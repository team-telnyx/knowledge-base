...
*Part 3 of 3 — see also: [Part 1](ai-assistants-workflows-testing-and-transfer-behavior--part-1.md), [Part 2](ai-assistants-workflows-testing-and-transfer-behavior--part-2.md)*
...
- [Dynamic Variables](dynamic-variables.md): Personalize prompts and route with runtime data.
- [Version Testing and Traffic Distribution](version-testing-and-traffic-distribution.md): Test assistant changes before sending all traffic to a new version.
- [Integrations](integrations.md): Connect assistants to external systems and data sources.
...
- [No-Code Voice Assistant](no-code-voice-assistant.md): Get started with Voice AI Assistants in the Portal.
