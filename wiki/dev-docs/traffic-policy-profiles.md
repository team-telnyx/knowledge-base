...
summary: Traffic Policy Profiles control what network traffic your SIMs are allowed
  or denied, filtering traffic at the network level before it reaches your devices.
  Profiles are assigned at the SIM Card Group level and support whitelist, blacklist,
  and throttling behaviors.
sources:
- url: https://developers.telnyx.com/docs/iot-sim/traffic-policy-profiles
updated_at: 2026-08-05T13:47:19Z
---

# Traffic Policy Profiles

Traffic Policy Profiles control what network traffic your SIMs are allowed or denied, filtering traffic at the network level before it reaches your devices. Profiles are assigned at the SIM Card Group level and support whitelist, blacklist, and throttling behaviors.
