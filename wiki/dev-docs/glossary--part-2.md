---
title: Glossary
summary: A consolidated reference of terminology used across the Telnyx developer
  documentation, covering artificial intelligence and machine learning concepts, API
  design and HTTP protocol vocabulary, and telecommunications and VoIP-specific terms.
sources:
...
updated_at: 2026-07-17T09:12:38Z
---

# Glossary

*Part 2 of 2 — see also: [Part 1](glossary--part-1.md)*

A consolidated reference of terminology used across the Telnyx developer documentation, covering artificial intelligence and machine learning concepts, API design and HTTP protocol vocabulary, and telecommunications and VoIP-specific terms.
