---
title: WebRTC Android SDK Error Handling
summary: A complete guide to error handling for the Android Voice SDK.
sources:
  - url: https://developers.telnyx.com/development/webrtc/android-sdk/error-handling/index
    content_hash: a5b9dbd06de7d49d874cc8b116d2210e53d364d216657900d4697abbc1a58c21
updated_at: 2026-04-10T00:00:00Z
---

# WebRTC Android SDK Error Handling

A complete guide to error handling for the Android Voice SDK
...
* **`CallState.DONE(reason: CallTerminationReason?)`**:
  ...
  * `CallTerminationReason` fields:
    * `cause: String?`: A high-level cause string (e.g., "CALL\_REJECTED", "USER\_BUSY", "NORMAL\_CLEARING").
    * `causeCode: Int?`: A numerical code associated with the cause (e.g., 21 for CALL\_REJECTED, 17 for USER\_BUSY, 16 for NORMAL\_CLEARING).
