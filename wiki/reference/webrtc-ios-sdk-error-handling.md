---
title: WebRTC iOS SDK Error Handling
summary: A comprehensive record of all updates, enhancements, and bug fixes.
sources:
  - url: https://developers.telnyx.com/development/webrtc/ios-sdk/error-handling/index
    content_hash: 0c6c9daed1a06010e46fa0f8c13ae7996bed11f43e01c5fc8907e6b06e73dd38
...
| --------- | ------- | ---------------------------------------------------------------------------------- |
| cause     | String? | General cause description (e.g., "CALL\_REJECTED", "USER\_BUSY")                   |
| causeCode | Int?    | Numerical code for the cause (e.g., 21 for CALL\_REJECTED)                         |
...
| UNALLOCATED\_NUMBER | The dialed number is invalid or does not exist |
| USER\_BUSY          | The remote user is busy                        |
| NORMAL\_CLEARING    | Normal call termination                        |
