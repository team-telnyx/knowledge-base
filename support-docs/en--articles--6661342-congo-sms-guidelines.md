...
scraped: 2026-07-08
content_hash: 5bba386efd458060af8ebbc21969ca68620394bfad1a7ebf22c1bc47cc0c089a
---
...
SMS Guidelines for D.R.o.t.C. See Telnyx guidance and requirements Learn more about Congo SMS Guidelines with Telnyx.
...
​**Dial Code:** 630
​
​[Alphanumeric Sender IDs](https://developers.telnyx.com/docs/messaging/messages/alphanumeric-sender-id) are supported.
​
For Network Vodacom (63001) Alphanumeric Sender IDs are only supported with registration. Outside of this network, Alphanumeric Sender IDs can be replaced by Generic Alpha Sender ID or random [Short Code](https://telnyx.com/products/sms-short-code).
​
