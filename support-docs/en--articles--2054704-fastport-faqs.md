...
If you received an error at the time of submitting your port request, this means that the information you have submitted does not match what is on file with the losing carrier. In order to rectify this issue, you will need to get in touch with the losing carrier to verify the information you have submitted.
...
Not all carriers are set-up to real-time analysis of their records so unfortunately, FastPort® is not available for all of the port requests you submit.
...
Depending on the option you select your port request can activate in 1 of 2 ways:

1. If you chose **On Demand**, you can go the port numbers page anytime within the activation window, click on the *View Details* button on the port request that is set for FOC and click the *Activate Now* button. Once you click the Activate button your numbers will port to Telnyx within a few moments.
