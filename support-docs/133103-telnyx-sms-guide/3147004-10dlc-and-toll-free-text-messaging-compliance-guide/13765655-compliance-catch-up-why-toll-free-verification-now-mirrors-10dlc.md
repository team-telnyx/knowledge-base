...
* **Business Registration Type:** You must specify your registration type: EIN, CBN, CRN, NEQ, PROVINCIAL\_NUMBER, VAT, ACN, ABN, BRN, SIREN, SIRET, NZBN, UST-IDNR, CIF, NIF, CNPJ, UID.
...
* Submissions without an EIN (using the SOLE\_PROPRIETOR classification) can now be subject to **Manual Verification**. This involves uploading a government-issued ID and sometimes a "live selfie" to prove identity, which can add more time to your approval time.
...
If a sole proprietor toll free submission is rejected for - *business registration number is missing or invalid*. Then we will need to submit for a manual verification to the carrier aggregators. Email our team directly at [tfverification@telnyx.com](mailto:tfverification@telnyx.com) with any business registration forms and we will file an appeal for a manual verification.

---

Related Articles

[Toll-Free Messaging](https://support.telnyx.com/en/articles/5353868-toll-free-messaging)[10DLC Carrier Error Codes Explanations](https://support.telnyx.com/en/articles/10547022-10dlc-carrier-error-codes-explanations)[Toll Free Verification Request Guide](https://support.telnyx.com/en/articles/10729979-toll-free-verification-request-guide)[Guide to Sole Proprietor 10DLC Brand and Campaign Registration](https://support.telnyx.com/en/articles/13545282-guide-to-sole-proprietor-10dlc-brand-and-campaign-registration)[Toll-Free Carrier Rejections](https://support.telnyx.com/en/articles/15138019-toll-free-carrier-rejections)
