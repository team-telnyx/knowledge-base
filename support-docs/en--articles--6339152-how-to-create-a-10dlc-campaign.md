...
| Use case | The use case that best matches your campaign:  * Two Factor Authentication * Alerts/Notifications * Agents and Franchises * Carrier Exemptions * Charity * Customer Care (Conversational Messaging) * Delivery Notifications * Emergency Alerts * Fraud Alerts * Education * Marketing * Political * Polling/Voting * Public Service Announcements * Security * Social * Sole Proprietor * Sweepstakes  *Messages sent that do not align with your registered use case may be subject to fines and throughput limitations and blocks.* |
