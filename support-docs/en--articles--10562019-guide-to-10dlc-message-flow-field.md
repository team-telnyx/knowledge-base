...
For more about a digital form go here: <https://support.telnyx.com/en/articles/10684260-10dlc-opt-in-form>
...
A customer may call [the number] or be present in the office. An employee will present the consent process verbally:
...
**If user does NOT reply YES**, they will not be opted in to promotional messaging and will only receiving informational messaging.
...
**If user does NOT reply YES**, they will not be opted in to political messaging and will only receiving informational messaging.
