...
To do so, visit the Customize LOA page in the portal [here](https://portal.telnyx.com/#/numbers/port-numbers/customize-loa). Then, click on the button in the top right of the page called `New LOA Template`. You will be brought to a new page that looks like this:
