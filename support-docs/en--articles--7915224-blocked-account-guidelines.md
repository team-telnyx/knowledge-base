...
2. ## Case Review:
   ...
   If you believe you have been blocked in error then you can contact our support team at [support@telnyx.com](mailto:support@telnyx.com). We will manually review your case to determine whether the block can be lifted. If we are unable to confirm that your traffic or activity follows best practices and our terms and conditions, then we may advise you to find an alternative vendor for all or some of the related traffic. However, if the offending traffic or behavior can be identified and fixed, there is a possibility of restoring your account. We receive many illegitimate requests to review an account blockage so not all requests may be reviewed or there may be a delay in processing.
...
4. ## Porting Away:
   ...
   Ultimately if the decision is made to permanently part ways we may grant temporary access to port your phone numbers away. We will waive the port out fee for blocked accounts. Please message [porting@telnyx.com](mailto:porting@telnyx.com).
5. ## Requesting a refund:

   If we have decided to keep the block permanently and you have any unused funds in your account then you may request a refund by emailing [billing@telnyx.com](mailto:billing@telnyx.com).
