...
* Telnyx does not currently support Number Portability for PT local Mainline numbers with associated services. Indeed if we port the did to Telnyx, it will cancel the local services delivered by the current provider.
