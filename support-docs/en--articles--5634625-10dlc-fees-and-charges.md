...
* [10DLC Carrier Fees](#h_63bfa99eb9)

  + [Registered Traffic](#h_6abc04b391)
  + [Unregistered Traffic](#h_0d0b62ee06)
* [T-Mobile Special Fees for High Volume](#h_266818b21f)
* [T-Mobile 10DLC Non-Compliance Fines](#h_7ae126e66f)
* [10DLC Sole Proprietor Maintenance Fee](#h_35510b8cca)

## Introduction

This resource contains a breakdown of all fees being charged by Carriers to register [10DLC](https://support.telnyx.com/en/articles/3679260-frequently-asked-questions-about-10dlc) Brands and Campaigns and send messages using 10DLC numbers. This resource also contains other fees charged by carriers for activities related to 10DLC and non-compliance fees charged by carriers relating to 10DLC.
...
In 2023, AT&T and T-Mobile notified customers of further increasing fees for outbound and inbound traffic for phone numbers not registered for 10DLC. These are detailed below.
...
If this applies to you, we also recommend [contacting us](https://telnyx.com/contact-us) to discuss alternative number types, such as [Short Code](https://telnyx.com/products/sms-short-code).
...
| Fraud | Attempted phishing, smishing, social engineering or similar practices that manipulate individuals to reveal credit card details, social security numbers or other private information.  **Cost:** $2000 |
| Illegal content especially cannabis | Any content which is not legal according to Federal or State (must be all 50 states) law. This includes Cannabis, Marijuana, Illegal Prescriptions and Solicitation.  **Cost:** $1000 |
