---
source_url: https://support.telnyx.com/en/articles/5941652-google-verified-calls-faq
...
Get to know Google Verified Calls: boosting call trust with business logos and reasons. See Telnyx guidance and requirements.
...
Most consumers won’t answer a call if they don’t recognize the caller. Analysis from Google showed that customers are [3 times](https://developers.google.com/business-communications/business-messages) more likely to pick up the phone, when the call has been marked as Verified by Google.
​

## How can my customers access Verified Calls?

Verified Calls is a feature on Google’s [Phone](https://play.google.com/store/apps/details?id=com.google.android.dialer&hl=en_US) app, which comes preloaded on many Android phones and is also available for download on the Play Store.
​
