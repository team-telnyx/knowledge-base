---
source_url: https://support.telnyx.com/en/articles/1130715-register-multiple-devices-on-one-connection
...
# Register multiple devices on one Connection

Need to register multiple devices to a single SIP connection? See Telnyx guidance and requirements Learn more about Register multiple devices on one Connection.




## How to register multiple devices with one credentials based connection

Telnyx Mission Control is designed for multi-tenant environments. You can create as many connections as you’d like to support all your customers and end-users.
​
Please note the example below as there is a limitation:
​
