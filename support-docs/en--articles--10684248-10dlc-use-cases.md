...
* **Account Notification:** Standard notifications for account holders, relating to and being about an account (i.e password reset, low-balance notification, suspicious login attempt, transaction alert).
