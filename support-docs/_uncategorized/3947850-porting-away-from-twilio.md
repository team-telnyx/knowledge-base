...
1) Reach out to Twilio porting support ([porting@twilio.com](mailto:porting@twilio.com)) to request a copy of the CSR information for the numbers on your account that you wish to port away.
...
2) Once you receive the CSR information from Twilio, you can now proceed with submitting your port-in request to Telnyx. To do this, please see [Porting into Telnyx](https://support.telnyx.com/en/articles/1130634-port-numbers-to-telnyx).
