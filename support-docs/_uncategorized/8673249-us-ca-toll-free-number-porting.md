...
Toll Free Number Porting should take approximately 2 business days, however, discover why the phone number [porting process can vary from 1 to 7 business days](https://telnyx.com/resources/porting-phone-numbers-take-long)
...
## **Seamless Number Porting with Telnyx**

Learn how Telnyx ensures a smooth and [efficient number porting process](https://telnyx.com/products/number-porting)

## **Resolving Porting Errors**

Find out how to troubleshoot [common error messages](https://support.telnyx.com/en/articles/1618776-porting-error-messages) during the number porting process with Telnyx

## **Best Practices for Porting Support**
