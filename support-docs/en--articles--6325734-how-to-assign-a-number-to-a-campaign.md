...
Follow these steps to assign a number in the portal. If you’d prefer to complete this step via the API, you can find details on how to do that in our [API documentation](https://developers.telnyx.com/docs/messaging/10dlc/concepts).
