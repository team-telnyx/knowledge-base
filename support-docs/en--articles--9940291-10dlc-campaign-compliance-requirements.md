...
* There is a $15 per submission or resubmission review fee that the carriers charge and Telnyx passes through.
* **Opt-in language must be specific just for text messages. It can not include e-mail or phone calls, this should be separate.**
* **Include Privacy Policy and T&C links in the registration.**
* If opt in is via pop up form, it needs to be noted in the CTA field of the registration.
* When a use case is verbal or over email/written, it's important to provide the script or sample of CTA how it is presented to subscribers to verify all aspect of CTA are fulfilled.
* Keywords and respective responses will be a cause for declines.

  + See Keyword Section Below for details.
* New Terms and Conditions requirements. (more below)
* If the CTA/Privacy Policy mentions marketing, the use case in TCR needs to include marketing. Conversely, it the marketing use case is chosen for the campaign, then the CTA/Message flow must contain mentions of marketing. The campaign description should also mention marketing.
* For customers lacking websites:

  + Provide a Google Business Profile
  + Provide a social media link (Linkedin/Instagram)
...
* Political:
  ...
  + For messaging involving donations (political/charity) make sure that both the TCR CTA and the Website CTA (read opt in) language should have a disclaimer that “Donations will be solicited."
  + Donations will be secured through \_\_\_\_ and Accreditation listing is \_\_\_\_\_.” should be present in program summary. A valid call-to-action and clear product description within the SMS terms of service which clearly discloses that donations will be solicited, should be included.

## 10DLC Campaign Detailed Requirements
...
#### Associated CTA Consent Principles:
...
• The workflow needs to be clear and detailed, following a format kind of like this but tweaked for the specific brand/campaign:
...
Marketing Use Case Example: “By submitting this form and signing up for texts, you consent to
...
link (where available). Text HELP for support. Privacy Policy [link] & Terms [link]. ”

![](_images/e45685282f304bdb.png)
...
### Subscriber Opt-in, Opt-Out, Help
...
![](_images/e693ec4b82268499.png)

![](_images/926b5281c8430351.png)
...
## SHAFT - Robust Age Gates (if applicable)
