---
source_url: https://support.telnyx.com/en/articles/1458084-global-number-types
scraped: 2026-06-11
---

Global Number Types | Telnyx Help Center

[Skip to main content](#main-content)

# Global Number Types

Here you will find an explanation of all the different number types that Telnyx offers: local, toll free & International.

Written by Mark Morse

June 6, 2024

Table of contents

In this article, we layout the different number types we support [globally](https://telnyx.com/products/phone-numbers).   
​  
Searching and purchasing these [number types](https://support.telnyx.com/en/articles/4380325-search-and-buy-numbers) has never been easier.
...
​  
You can view our domestic coverage [here](https://telnyx.com/resources/telnyx-domestic-coverage-map).
...
​  
Learn more about quickship through our API [here](https://developers.telnyx.com/api/numbers/list-available-phone-number-blocks).  
​  
...
​  
Please see our dedicated [article](https://support.telnyx.com/en/articles/5353868-toll-free-messaging) for more details on acceptable use cases for toll free messaging.

## **International Number Types**

As we continue to globalise as a company, our [international coverage map](https://telnyx.com/global-coverage) along with number types continues to grow.   
​  
