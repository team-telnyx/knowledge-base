...
* [User manual](https://documentation.grandstream.com/knowledge-base/wave-lite-android-user-manual/#custom-settings)
...
1. [Configure a Telnyx SIP trunk on your device](#h_fc8d826d6e)
2. [Configure call settings](#h_fb05fe822b)
3. [Configure codecs](#h_0a0728643d)
4. [(Optional) Configure your STUN server](#h_4098b128d5)
...
4. Fill out the following:
   ...
   4. **SIP User ID:** The SIP connection username. Learn more [here](https://support.telnyx.com/en/articles/4245868-sip-connection-types) in the Credentials Connection Setup section.
